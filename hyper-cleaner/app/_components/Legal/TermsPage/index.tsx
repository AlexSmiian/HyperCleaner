...
export default function TermsPage() {
    return (
        <article className={styles.mainPage}>
            <section>
                <h1 className={styles.titleH1}>TERMS OF USE</h1>
                <h4 className={styles.titleH4}>Effective Date: March 21, 2025</h4>
                <H2 classModifier={styles.titleH2}>
                    INTRODUCTION
                </H2>
                <p className={styles.mb10}>
                    These Terms of Use (the “<b>Terms</b>“) apply to your access and use of our mobile application
                    “<b>Hyper Cleaner</b>” (the “<b>App</b>”), our websites websites (including but not limited to <Link href={'https://hypercleaner.app/'}>https://hypercleaner.app/</Link>),
                    our blog, and all related services, features, materials, and content available for your use
                    (collectively the “<b>Service</b>“)
                    provided by Gismart Limited, a private limited company, incorporated and registered in England and
                    Wales
                    with company number
                    10152488 whose registered office is at 151 Wardour Street, London, England, W1F 8WE (“<b>we</b>”,
                    “<b>us</b>”, “<b>our</b>” or the “<b>Company</b>”).
                </p>
                <p className={styles.mb10}>
                    If you have any questions about the Terms or our Service, please contact us at <Link
                    href={'mailto:support@hypercleaner.app'}>support@hypercleaner.app</Link>.
                </p>
                <p className={styles.mb10}>
                    Any words following the terms ‘including’, ‘include’, ‘in Depending on your location, payment
                    method, or
                    other relevant factors, your access to the Service, including through sales or payment processing,
                    may
                    be facilitated by <b>Gismart Limited</b> or its authorized partners,<b>Extramile Limited</b>, a
                    company incorporated
                    in Cyprus, company number ΗΕ 445953, whose registered office is located at Prodromou, 75, Oneworld
                    Parkview House, Floor 4, 2063, Nicosia, Cyprus; or <b>Fulfilling Inc.</b>, a Delaware corporation
                    with its
                    registered address at 1007 N Orange St. 4th Floor Site 1382, Wilmington, New Castle, 19801. These
                    partners <b>do not provide the Service</b>, manage subscriptions, or assume any obligations related
                    to the
                    operation, support, or performance of the Service. Your contractual relationship is solely with
                    Gismart
                    Limited. Your rights and obligations under these Terms remain the same, regardless of the designated
                    partner, and neither Gismart Limited nor its partners shall be jointly liable for each other’s
                    obligations unless expressly stated in these Terms.
                </p>
            </section>
            <section>
                <H2>
                ...
                <p className={styles.mb10}>
                    These Terms include a Binding Arbitration Provision in Section 18 that significantly impacts your
                    legal rights. The arbitration provision mandates that any disputes or claims arising from or related
                    to these Terms or our Service will be resolved exclusively through arbitration on an individual
                    basis.
                </p>
                <p className={styles.mb10}>
                ...
                <p className={styles.mb10}>
                    <strong>CLASS ACTION WAIVER:</strong> Section 18 includes a waiver of your right to participate in
                    class actions or other collective proceedings.
                </p>
                <p className={styles.mb10}>
                    <strong>DISCLAIMERS OF WARRANTIES:</strong> Section 10 contains disclaimers regarding warranties related to our Service.
                </p>
                <p className={styles.mb10}>
                    <strong>LIMITATION OF LIABILITY:</strong> Section 11 outlines the limitations on our liability for damages or losses.
                </p>
                <p className={styles.mb10}>
                ...
                <p className={styles.mb10}>
                    <strong>IF YOU DO NOT AGREE TO THESE TERMS (INCLUDING BUT NOT LIMITED TO BINDING ARBITRATION PROVISION), YOU MUST NOT ACCESS OR USE OUR SERVICE. CONTINUED USE OF THE SERVICE CONSTITUTES YOUR ONGOING AGREEMENT TO THESE TERMS.</strong>
                </p>
            </section>
            <section>
                <H2>
                ...
                <p className={styles.mb10}>We may change, modify, or remove portions of these Terms at our sole discretion. If we make changes to these Terms, we may post the updated version within our Service and revise the "Effective Date" accordingly. At our discretion, we may also notify you of significant changes.</p>
                <p className={styles.mb10}>If you do not agree with any updated Terms, you must stop using the Service, delete your account, or cancel your subscription before the Effective Date. Your continued use after changes is implemented constitutes your acceptance of the updated Terms. We encourage you to regularly review these Terms for updates.</p>
            </section>
            <section>
                <H2>
            ...
            <section>
                ...
                <p className={styles.mb10}>
                    <strong>Age Restrictions.</strong> Anyone under the age of thirteen (13) years (or the minimum age required by applicable law in their jurisdiction) is strictly prohibited from creating an account or using the Service without explicit parental or legal guardian consent.
                </p>
                <p className={styles.mb10}>
                    By providing consent for a child to use the Service, parents and guardians agree to the following:
                </p>
                <p className={styles.mb10}>a) full responsibility and oversight of the child's use of the Service, ensuring compliance with these Terms, all referenced documents, and all applicable laws;</p>
                <p className={styles.mb10}>b) liability for the child’s compliance with these Terms and for any activity conducted through the child’s account;</p>
                <p className={styles.mb10}>c) acceptance of all disclaimers, waivers, and limitations of liability set out in these Terms both on behalf of themselves and the child. Any references to "you " or "your" in relation to the limitations of liability, disclaimers, and indemnifications under these Terms shall be deemed to include the child or ward.</p>
                <p className={styles.mb10}>
                    <strong>Access to the Service.</strong> To use and fully access our Service, you may be required to create an account (“Account”). By doing so, you agree to provide accurate, current, and complete information and to promptly update any changes to your information. Unless otherwise agreed in these Terms, you are responsible for ensuring that all activities performed through your Account represent your own authentic use of the Service. Unless otherwise agreed in these Terms, you accept full responsibility for any actions or activities conducted under your Account, whether through your computer, mobile device, or other means. Your login credentials, including your username and password, are strictly for personal use and must be kept secure and confidential. Sharing your login credentials with others is expressly prohibited, and any breach of this obligation may result in suspension or termination of your Account.
                </p>
                <p className={styles.mb10}>
                    If you suspect unauthorized access to your Account or any security breach, you must notify us immediately via <Link href={'mailto:support@hypercleaner.app'}>support@hypercleaner.app</Link>.
                </p>
            </section>
            <section>
                <H2>
                ...
                <p className={styles.mb10}>
                    Certain features of the App are accessible exclusively through a subscription. We offer various
                    subscription options that may include but are not limited to weekly, monthly, and annual
                    subscription options. Subscriptions can be purchased via the App Store, Google Play, or directly
                    from our website using a credit/debit card or PayPal. We may also provide different offers and
                    challenges at a discounted rate.
                </p>
                <p className={styles.mb10}>
                    <strong>Trial Subscriptions</strong>
                </p>
                <p className={styles.mb10}>
                    We may provide trial subscriptions, which can be either free or paid, allowing temporary access to
                    our App. If a trial is available, this will be explicitly stated during the checkout process. If no
                    such notice is provided, your subscription purchase will proceed without any trial period. We
                    reserve the right to restrict your ability to participate in multiple trial offers.
                </p>
                <p className={styles.mb10}>
                    <strong>Automatic Conversion to Paid Subscription:</strong> Unless you cancel at least 24 hours
                    before the trial ends, your payment method will be charged the subscription fee displayed during
                    purchase for the selected subscription plan.
                </p>
                <p className={styles.mb10}>
                    <strong>Subscription Terms and Renewals</strong>
                </p>
                <p className={styles.mb10}>
                    When you subscribe, your plan will renew automatically at the end of each billing cycle (weekly,
                    monthly, annually, or as selected).
                </p>
                <p className={styles.mb10}>
                    <strong>Renewal Charges.</strong> Charges for renewal will be processed within 24 hours before the
                    subscription term ends. Cancellations made less than 24 hours before renewal will take effect only
                    after the subsequent term.
                </p>
                <p className={styles.mb10}>
                    <strong>Pricing Changes.</strong> We reserve the right to modify subscription fees at any time, to
                    the fullest extent allowed by applicable laws. Advance notice of subscription fees changes may be
                    sent to you, and the updated subscription fee will apply to the next billing cycle. Updated
                    subscription fees will take effect at the start of the next subscription term after the change is
                    implemented. By continuing to use the subscription after the updated pricing takes effect, you agree
                    to the new subscription fees. If you do not accept the subscription fees change, you can cancel your
                    subscription at least 24 hours before the end of the current subscription term to avoid further
                    charges.
                </p>
                <p className={styles.mb10}>
                    <strong>Promotions.</strong> We may offer promotional discounts. These discounts apply only to the
                    initial payment and do not affect future renewal fees
                </p>
                <p className={styles.mb10}>
                    <strong>No Future Commitments.</strong> By subscribing, you agree that your purchase is not
                    contingent on any future features, updates, or functionality, nor on any representations made by us.
                </p>
                <p className={styles.mb10}>
                    <strong>Billing</strong>
                </p>
                <p className={styles.mb10}>
                    <strong>Payment Authorization.</strong> You authorize us to charge the payment method provided at
                    checkout or at the end of any trial period. Payment options include credit/debit cards, PayPal,
                    Apple Pay, Google Pay etc. If you purchase a subscription through the App Store or Google Play, the
                    payment will be charged to your credit/debit card via your respective account upon confirmation of
                    your subscription. Alternatively, if you subscribe through our websites (including but not limited
                    to <Link href={'https://hypercleaner.app/'}>https://hypercleaner.app/</Link>), the payment will be
                    processed using your credit/debit card or PayPal account once you select a subscription and confirm
                    your purchase.
                </p>
                <p className={styles.mb10}>
                    <strong>Non-Refundable Transactions.</strong> Except where applicable law provides otherwise or as outlined in these Terms, all payments are final, non-refundable, and non-transferable.
                </p>
                <p className={styles.mb10}>
                    <strong>Validation Fee.</strong> A small temporary validation charge may be applied to verify the validity of your payment method. This charge will be refunded immediately.
                </p>
                <p className={styles.mb10}>
                ...
                <p className={styles.mb10}>
                    <strong>Website Purchases:</strong> Refunds for subscriptions purchased directly through our websites are limited and may only be granted in specific cases, such as where required by law (e.g., statutory cooling-off periods in certain jurisdictions) or confirmed technical bugs.
                </p>
                <p className={styles.mb10}>
                    <strong>Confirmed Technical Bugs:</strong> In cases where a verifiable and confirmed technical bug prevents the proper use of the Service, a refund request may be considered. To determine whether an issue qualifies as a bug, you must provide us with all necessary technical details. Only after we review the information and confirm that the issue is a bug that materially affects the functionality of the Service may a refund be considered.
                </p>
                <p className={styles.mb10}>
                    <strong>App Store or Google Play Purchases:</strong> If you purchased your subscription through the Apple App Store or Google Play, refund requests must be directed to the respective platform, as they manage all billing and refund decisions independently.
                </p>
                <p className={styles.mb10}>
                    <strong>U.S. Purchases:</strong> Residents of California or Connecticut may cancel a subscription up until midnight of the third business day following the date of purchase and receive a full refund, provided there is no breach of these Terms.
                </p>
                <p className={styles.mb10}>
                ...
                <p className={styles.mb10}>
                    <strong>For Website Purchases:</strong> You must cancel your subscription before it renews to avoid the billing of the fees for the next subscription period via sending a cancellation request via <Link href={'mailto:support@hypercleaner.app'}>support@hypercleaner.app</Link>.
                </p>
                <p className={styles.mb10}>
                    <strong>For App Store Purchases:</strong> If you subscribed or started a trial through the App Store, manage your subscription settings within your Apple Account. Ensure cancellation is completed at least 24 hours before the trial or current subscription term ends. For more information, visit <Link href={'https://support.apple.com/en-ca/118428'}>Apple’s support page on managing subscriptions</Link>.
                </p>
                <p className={styles.mb10}>
                    <strong>For Google Play Purchases:</strong>  If you subscribed or started a trial through Google Play, manage your subscription settings within your Google Account. Cancellation must be done at least 24 hours before the trial or current subscription term ends. Learn more about managing subscriptions on <Link href={'https://support.google.com/googleplay/answer/7018481?co=GENIE.Platform%3DAndroid&hl=en'}>Google’s support page</Link>.
                </p>
            </section>
            <section>
                <H2>
                ...
                <p className={styles.mb10}>
                    <strong>Your Permitted Use of the Service.</strong> We allow you to use the Service exclusively for your personal, non- commercial purposes, as intended and defined by us. Any use of the Service for commercial, resale, automated data collection, unauthorized tracking, or any other purpose not expressly authorized by us is strictly prohibited.
                </p>
                <p className={styles.mb10}>
                    <strong>Your Prohibited Use of Service.</strong> You agree not to use the Service, directly or indirectly, for any unlawful or unauthorized purposes, or in a manner that violates these Terms, including but not limited to:
                </p>
                <p className={styles.mb10}>
            ...
            <section>
                <H2>COMMUNICATION AND CUSTOMER SUPPORT</H2>
                <p className={styles.mb10}>
                    <strong>Support.</strong> If you have any questions, or concerns, or require assistance regarding our Service, you may reach out to us using the contact information provided in the “INTRODUCTION” section of these Terms. While we are not legally obligated to provide customer support, we may, at our sole discretion, choose to offer support services to users when necessary. Such support, if provided, is offered as a courtesy and does not create any ongoing obligation or entitlement to future support. We will make reasonable efforts to respond promptly to your inquiries; however, we do not guarantee a specific response time.
                </p>
                <p className={styles.mb10}>
                    <strong>Feedback.</strong> We welcome your feedback. You will be prompted to submit comments, suggestions, ideas, feedback, ratings, materials, or other information
                    ("<strong>Feedback</strong>") to us through the App. You hereby agree that all Feedback that you disclose or submit to us through the App is voluntary, non-confidential, and becomes and remains our property. Your disclosure or submission of Feedback to us constitutes an assignment to us of all rights, title, and interest in and to the Feedback. We may disclose or use any Feedback as we see fit without any compensation to you.
                </p>
            </section>
            <section>
                ...
                <p className={styles.mb10}>
                    Alternatively, you can send the notice to us via <Link href={'mailto:support@hypercleaner.app'}>support@hypercleaner.app</Link> or contact us by post.
                </p>
                <p className={styles.mb10}>
            ...
            <section>
                <H2>TERMINATION</H2>
                <p className={styles.mb10}>
                    <strong>Term.</strong> These Terms take effect from the date you first access or use our Service and will remain in force until terminated in accordance with this Section.
                </p>
                <p className={styles.mb10}>
                    <strong>Termination by Us.</strong> We may terminate these Terms, suspend or restrict your access to the Service, or delete your Account immediately upon providing notice if:
                </p>
                <p className={styles.mb10}>
                ...
                <p className={styles.mb10}>
                    <strong>Termination by You.</strong> You may terminate these Terms at any time by ceasing to use the Service. If you have purchased a subscription, please refer to Section 6 of these Terms for detailed instructions on how to cancel your subscription properly to avoid future billing.
                </p>
                <p className={styles.mb10}>
                    <strong>Effect of Termination.</strong> Upon termination of these Terms all licenses granted to you under these Terms will immediately terminate and all provisions that by their nature are intended to survive termination shall remain in effect. This includes, but is not limited to, provisions relating to Sections 8, 9, 10, 11, 12, 14, 18, 20 and any other provisions necessary to enforce rights or obligations that accrued prior to termination.
                </p>
            </section>
            <section>
                ...
                <p className={styles.mb10}>
                    <strong>For Users in the European Union, United Kingdom, Liechtenstein, Switzerland, Norway, or Iceland.</strong> If you reside in the European Union, United Kingdom, Liechtenstein, Switzerland, Norway, or Iceland, any Disputes arising out of or relating to these Terms, including their interpretation, enforcement, or validity, shall be governed by and construed in accordance with the laws of your country of residence. The courts of your usual place of residence shall have exclusive jurisdiction over any Disputes (as defined herein) that are not resolved through the arbitration agreement outlined in these Terms.
                </p>
                <p className={styles.mb10}>
                    <strong>For Users in the United States or Other Jurisdictions.</strong> If you reside in the United States or any other jurisdiction not listed above, any Disputes arising out of or relating to these Terms shall be resolved exclusively through the arbitration agreement provided herein, and the governing law shall be determined as specified in the arbitration clause.
                </p>
                <p className={styles.mb10}>
                    By accessing or using our Service, you agree that any disputes, claims, or controversies arising out of or relating to these Terms, the breach, termination, enforcement, interpretation, or validity thereof, or your use of the Service (collectively, "<strong>Disputes</strong>"), will be resolved solely by binding, individual arbitration (i.e. not in a class, representative or consolidated action or proceeding), unless expressly provided otherwise in this Section or to the extent that the applicable law prohibits the exclusive use of arbitration for dispute resolution. This includes any claims against our affiliates, subsidiaries, employees, officers, agents, or licensors.
                </p>
                <p className={styles.mb10}>
                    Notwithstanding the above, the following exceptions apply:
                </p>
                <p className={styles.mb10}>
                    <strong>Small Claims Court:</strong> Either party retains the right to bring an individual claim in small claims court for disputes or claims within the jurisdictional limits of such a court.
                </p>
                <p className={styles.mb10}>
                    <strong>Injunctive or Equitable Relief:</strong> Either party may seek injunctive or equitable relief in a court of competent jurisdiction to protect or enforce intellectual property rights, including copyrights, trademarks, trade secrets, patents, or similar proprietary rights.
                </p>
                <p className={styles.mb10}>
                    <strong>AGREEMENT TO WAIVE JURY TRIAL AND CLASS ACTION</strong>
                </p>
                <p className={styles.mb10}>
                ...
                <p className={styles.mb10}>
                    <strong>Arbitration Procedure and Applicable Rules</strong>
                </p>
                <p className={styles.mb10}>
                    You further agree that all disputes between you and us will be resolved exclusively through binding arbitration before a single, neutral arbitrator, administered by the American Arbitration Association (“<strong>AAA</strong>”) under its Commercial Arbitration Rules and the Supplementary Procedures for Consumer-Related Disputes (the “<strong>AAA Rules</strong>”) then in effect, except as modified herein.
                </p>
                <p className={styles.mb10}>
                    <strong>Place of Arbitration.</strong> The arbitration proceedings shall be held in Delaware, United States unless the parties agree to an alternative location.
                </p>
                <p className={styles.mb10}>
                    <strong>Governing Law.</strong> The arbitration shall be conducted in accordance with the laws of the State of Delaware, consistent with the Federal Arbitration Act, including any applicable statutes of limitations and recognized legal privileges.
                </p>
                <p className={styles.mb10}>
                    <strong>Language of Arbitration.</strong> The arbitration will be conducted in the English language.
                </p>
                <p className={styles.mb10}>
                    <strong>Commencing Arbitration.</strong> To initiate arbitration, you must adhere to the procedures outlined by the AAA Rules, which are accessible on this <Link href={'https://www.adr.org/contact-us/'}>page</Link>.
                </p>
                <p className={styles.mb10}>
                    <strong>Filing Deadline.</strong>  By accessing or using our Service, you agree that any Dispute (as defined herein) must be initiated by filing a demand for arbitration or commencing an individual legal action within one (1) year from the date the party asserting the Dispute first becomes aware, or reasonably should have become aware, of the act, omission, or event giving rise to the Dispute. Except where prohibited by applicable law, any Dispute not initiated within this one-year period will be permanently barred, and no remedy shall be available for such untimely Disputes.
                </p>
                <p className={styles.mb10}>
                    <strong>Selection of the Arbitrator.</strong> The arbitrator responsible for adjudicating the dispute will be selected in accordance with the procedures specified in the AAA Rules.
                </p>
                <p className={styles.mb10}>
                    <strong>Hearing Requirements.</strong> For claims of $10,000 or less, the arbitration will generally proceed on the basis of written submissions from the parties, unless a hearing is requested by you or deemed necessary by the arbitrator. For claims exceeding $10,000, the need for a hearing will be determined by the AAA Rules. The arbitrator shall have the discretion to oversee and regulate the exchange of information between the parties. No party or representative shall engage in ex-parte communications with the arbitrator. All communications must be made in the presence of, or with notice to, all parties involved in the arbitration.
                </p>
                <p className={styles.mb10}>
                    <strong>Judgment and Finality of Award.</strong> The arbitrator shall deliver the award within the timeline prescribed by the AAA Rules. The award may be enforced in any court with appropriate jurisdiction. The arbitration award shall be final and binding, and there shall be no appeal. Any damages awarded by the arbitrator must conform to the limitations specified in the applicable “<strong>Limitation of Liability</strong>” section, including including restrictions on the types and amounts of damages recoverable.
                </p>
                <p className={styles.mb10}>
                    <strong>Remedies.</strong> The arbitrator shall have no authority to award punitive or other damages not measured by the prevailing party's actual damages, except as may be required by statute.
                </p>
                <p className={styles.mb10}>
                    <strong>Individual Relief Only.</strong> The arbitrator may award relief solely in favor of the individual party seeking relief and only to the extent necessary to resolve that party's individual claim. The arbitrator shall have no authority to award relief to or against anyone who is not a party to the arbitration. Furthermore, the arbitrator may not consolidate multiple parties' claims or preside over any form of class, joint, or representative proceeding.
                </p>
                <p className={styles.mb10}>
                    <strong>Fees.</strong> Your obligation to cover any filing, administrative, or arbitrator fees shall be governed exclusively by the fee schedule outlined in the AAA Rules.
                </p>
                <p className={styles.mb10}>
                    <strong>Assessment of Fees.</strong> The prevailing party shall be entitled to an award of reasonable attorney fees. The allocation of forum fees and expenses shall be determined by the arbitrator.
                </p>
                <p className={styles.mb10}>
                    <strong>Confidentiality.</strong> Except as may be required by law, neither a party nor an arbitrator may disclose the existence, content, or results of any arbitration hereunder without the prior written consent of both parties.
                </p>
                <p className={styles.mb10}>
                    <strong>Opt-Out Option.</strong> You may opt out of this arbitration agreement within 30 days of accepting these Terms by submitting your notice via <Link href={'mailto:support@hypercleaner.app'}>support@hypercleaner.app.</Link>, stating your intention to opt out. Opting out will not affect other provisions of these Terms.
                </p>
                <p className={styles.mb10}>
                    <strong>Severability.</strong> If any portion of this arbitration agreement is deemed invalid or unenforceable, that portion shall be severed, and the remaining provisions shall remain in full force and effect. However, if the waiver of class actions and collective relief is found unenforceable, the arbitration shall proceed on an individual basis only to the fullest extent permitted by law.
                </p>
                <p className={styles.mb10}>
                    <strong>Survival.</strong> Except stated otherwise, this arbitration agreement shall survive termination of these Terms.
                </p>
            </section>
            <section>
                ...
                <p className={styles.mb10}>
                    <strong>Exceptions to the Right of Withdrawal.</strong> When purchasing digital content online, including single-use items, you agree that the content will be available to you immediately. By consenting to immediate access, you acknowledge that you waive your right of withdrawal and are not eligible for a refund. When you purchase a subscription to access our Service, which are provided on a continuous basis, your access to the Service begins immediately upon completing the purchase. By consenting to the immediate commencement of your Subscription, you acknowledge and agree to waive your statutory right of withdrawal.
                </p>
                <p className={styles.mb10}>
                    <strong>Exercising Your Right of Withdrawal.</strong> To exercise your right of withdrawal (where applicable), you must send an unequivocal statement of your intention to withdraw from the contract (i.e., these Terms). This can be done by:
                </p>
                <p className={styles.mb10}>
                ...
                <p className={styles.mb10}>
                    Submitting your notice via <Link href={'mailto:support@hypercleaner.app'}>support@hypercleaner.app</Link>.
                </p>
                <p className={styles.mb10}>
                ...
                <p className={styles.mb10}>
                    <strong>Refunds.</strong> If you exercise your right of withdrawal, we will deduct a proportionate amount corresponding to the Service you have used up to the time of notification. Refunds will be processed using the same payment method used for the original transaction, unless agreed otherwise.
                </p>
                <p className={styles.mb10}>
                    <strong>Alternative Dispute Resolution (ADR).</strong>
                </p>
                <p className={styles.mb10}>
                    In the event of a dispute arising from or relating to these Terms, you and the Company will first attempt to resolve the matter through negotiations. If no resolution is reached within 30 days of written notice to negotiate, the parties may voluntarily explore a good-faith resolution through an agreed alternative dispute resolution (ADR) procedure. Participation in ADR is not mandatory and is entirely at the discretion of each party. If ADR is unsuccessful within 60 days, or if a party refuses to participate, the dispute may proceed to arbitration. European consumers (including those in Norway, Switzerland, Iceland, or Liechtenstein) may use the European Commission’s Online Dispute Resolution (ODR) platform for disputes related to online contracts. The platform is accessible at <Link href={'https://consumer-redress.ec.europa.eu/site-relocation_en?event=main.home.chooseLanguage'}>ODR Platform Link</Link>.
                </p>
            </section>
            <section>
                <H2>MISCELLANEOUS</H2>
                <p className={styles.mb10}>
                    <strong>Governing Law.</strong> These Terms shall be governed by and construed in accordance with the laws of the State of Delaware, U.S. without regard to its conflict of laws principles, and excluding the 1980 UN Convention on Contracts for the International Sale of Goods.
                </p>
                <p className={styles.mb10}>
                    <strong>Entire Agreement.</strong> These Terms constitute the entire agreement between you and us regarding your access to and use of the Service and supersede all prior agreements, understandings, or representations, whether written or oral.
                </p>
                <p className={styles.mb10}>
                    <strong>No Waiver.</strong> Failure or delay by us to exercise any right or enforce any provision under these Terms shall not operate as a waiver of such right or provision. A waiver will only be effective if explicitly stated in writing and signed by an authorized representative.
                </p>
                <p className={styles.mb10}>
                    <strong>Severability.</strong> If any provision of these Terms is found to be invalid or unenforceable by a court of competent jurisdiction, that provision shall be modified or severed to the minimum extent necessary to comply with the law, without affecting the enforceability of the remaining provisions.
                </p>
                <p className={styles.mb10}>
                    <strong>Assignment.</strong> You may not assign or transfer your rights or obligations under these Terms without our prior written consent. We may assign or transfer our rights and obligations under these Terms at any time and without prior notice, including via novation. Posting an updated version of these Terms identifying the new party shall serve as valid notice of such transfer. These Terms are binding and will inure to the benefit of both parties and their respective successors, assigns, and legal representatives.
                </p>
                <p className={styles.mb10}>
                ...
                <p className={styles.mb10}>
                    <strong>Force Majeure.</strong> We shall not be held liable for any delay or failure to perform our obligations under these Terms due to causes beyond our reasonable control, including but not limited to natural disasters, governmental actions, labor disputes, or disruptions in telecommunications.
                </p>
                <p className={styles.mb10}>
                    <strong>Third-Party Rights.</strong> Except as expressly stated herein, these Terms are intended solely for the benefit of the parties and do not create any rights for third-party beneficiaries.
                </p>
                <p className={styles.mb10}>
                    <strong>Headings and Construction.</strong> Headings in these Terms are provided for convenience only and shall not affect their interpretation.
                </p>
            </section>
        </article>
    )
